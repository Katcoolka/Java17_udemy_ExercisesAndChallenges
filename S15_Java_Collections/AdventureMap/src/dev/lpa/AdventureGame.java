...
public class AdventureGame {
    ...
    private void loadLocations(String data) {
        for (String s : data.split("\\R")) { // "\\R" is a way to split up the text block by each line
        ...
        //adventureMap.forEach((k, v) -> System.out.printf("%s:%s%n", k, v)); //commented to not print the map at the start of the game
    }
