...
public class Student {
    ...
    //Stream Challenge - method to randomize the courses each student gets
    ...
    public static Student getRandomStudent(Course... courses) {
        ...
        Course[] randomCourses = getRandomSelection(courses); //Stream Challenge
        ...
        Student student = new Student(
                ...
                getRandomVal("M", "F", "U"),
                random.nextBoolean(),
                randomCourses); //Stream Challenge - courses replaced with randomCourses

        for (Course c : randomCourses) { //Stream Challenge - courses replaced with randomCourses
