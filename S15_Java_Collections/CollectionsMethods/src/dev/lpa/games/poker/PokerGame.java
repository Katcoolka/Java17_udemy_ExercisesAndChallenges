...
public class PokerGame {
    ...
    public void startPlay() {
        ...
        Card.printDeck(deck);
        int randomMiddle = new Random().nextInt(15, 35); //to randomize the cut
        //Collections.rotate(deck, 26); //cutting deck in half
        ...
        //remainingCards = new ArrayList<>(cardsRemaining);//shows empty list
