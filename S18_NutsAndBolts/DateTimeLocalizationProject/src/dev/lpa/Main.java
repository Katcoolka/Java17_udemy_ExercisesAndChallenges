...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //to test if it is really true that difference between Jane and Joe is 15 hrs
        ...
        //which employee is in Daylight savings time
...
//                joeNow.format(DateTimeFormatter.ofPattern("zzzz z")));
        ...
        int days = 10; //10 options of days for scheduled meeting
